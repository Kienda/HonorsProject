...
public:
    ...
    void setupUi(QMainWindow *StudentSuccess)
    {
        if (StudentSuccess->objectName().isEmpty())
            StudentSuccess->setObjectName("StudentSuccess");
        StudentSuccess->resize(800, 600);
        StudentSuccess->setStyleSheet(QString::fromUtf8("background-color: rgb(159, 166, 170);"));
        centralwidget = new QWidget(StudentSuccess);
...
"}"));
        ...
        StudentSuccess->setCentralWidget(centralwidget);
        menubar = new QMenuBar(StudentSuccess);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 21));
        StudentSuccess->setMenuBar(menubar);
        statusbar = new QStatusBar(StudentSuccess);
        statusbar->setObjectName("statusbar");
        StudentSuccess->setStatusBar(statusbar);
        ...
        retranslateUi(StudentSuccess);

        QMetaObject::connectSlotsByName(StudentSuccess);
    } // setupUi

    void retranslateUi(QMainWindow *StudentSuccess)
    {
        StudentSuccess->setWindowTitle(QCoreApplication::translate("StudentSuccess", "MainWindow", nullptr));
        signUpBox->setTitle(QCoreApplication::translate("StudentSuccess", "Create Your Account", nullptr));
        gpa->setText(QString());
        signUp->setText(QCoreApplication::translate("StudentSuccess", "Signup", nullptr));
        loginBox->setTitle(QCoreApplication::translate("StudentSuccess", "Please login:", nullptr));
        StudentId->setText(QString());
        login->setText(QCoreApplication::translate("StudentSuccess", "login", nullptr));
        moto->setPlainText(QCoreApplication::translate("StudentSuccess", "Student Success Empowers \n"
...
namespace Ui {
    class StudentSuccess: public Ui_StudentSuccess {};
} // namespace Ui
